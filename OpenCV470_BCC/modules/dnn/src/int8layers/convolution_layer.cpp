...
//                                            v_int8x16 v00 = (v_int8x16)v_load((const schar*)(imgptr0 + in_j));
                                            v_int8x16 v00 = (v_int8x16)v_load((const schar*)(imgptr0 + in_j)),
                                                      v01 = (v_int8x16)v_load((const schar*)(imgptr0 + in_j + dilation_w)),
                                                      v02 = (v_int8x16)v_load((const schar*)(imgptr0 + in_j + dilation_w*2)),
                                                      v10 = (v_int8x16)v_load((const schar*)(imgptr1 + in_j)),
                                                      v11 = (v_int8x16)v_load((const schar*)(imgptr1 + in_j + dilation_w)),
                                                      v12 = (v_int8x16)v_load((const schar*)(imgptr1 + in_j + dilation_w*2)),
                                                      v20 = (v_int8x16)v_load((const schar*)(imgptr2 + in_j)),
                                                      v21 = (v_int8x16)v_load((const schar*)(imgptr2 + in_j + dilation_w)),
                                                      v22 = (v_int8x16)v_load((const schar*)(imgptr2 + in_j + dilation_w*2));
                        ...
                        for( int i = 0; i < outCn; i += 2 )
                        {
                            ...
                            for( ; j <= bsz - 4; j += 4 )
                            {
                                ...
                                {
                                    v_int8x16 w0 = (v_int8x16)v_load_aligned((const schar*)(wptr0 + k));
                                    v_int8x16 w1 = (v_int8x16)v_load_aligned((const schar*)(wptr1 + k));
                                    v_int8x16 r0 = (v_int8x16)v_load_aligned((const schar*)(rptr));
                                    v_int8x16 r1 = (v_int8x16)v_load_aligned((const schar*)(rptr + vsz_a));
                                    v_int8x16 r2 = (v_int8x16)v_load_aligned((const schar*)(rptr + vsz_a*2));
                                    v_int8x16 r3 = (v_int8x16)v_load_aligned((const schar*)(rptr + vsz_a*3));
